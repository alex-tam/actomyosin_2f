...
"Obtain dimensionless, un-translated motor position"
function get_motor_pos(m::Myosin_Motor, s::State{T}, Lxx, Lxy, Lyx, Lyy) where {T}
    # Find relative position along segment
    seg1, seg2, r1, r2 = get_motor_relative_pos_segment(m::Myosin_Motor, s::State, Lxx, Lxy, Lyx, Lyy)
    # Obtain segment nodes position (dimensionless, un-translated)
